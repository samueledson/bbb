...
class ApplicationService:
    ...
    def save_answers(self, application_id: int, answers: List[AnswerCreateSchema]) -> List[QuestionModel]:
        self.validate_application(application_id=application_id)
        return AnswerRepository(self.db).save_answers(application_id=application_id, answers=answers)
